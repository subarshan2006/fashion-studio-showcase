...
import { f as frame, d as cancelFrame, i as interpolate, s as supportsViewTimeline, e as supportsScrollTimeline, p as progress, v as velocityPerSecond, g as isHTMLElement, h as defaultOffset$1, j as clamp, n as noop, k as resize, l as frameData, u as useConstant, o as useIsomorphicLayoutEffect, q as invariant, t as motionValue, w as MotionConfigContext, x as collectMotionValues } from "./Reveal-CDzIhyov.js";
...
const g1 = "/fashion-studio-showcase/assets/g1-1Gu2O3oZ.jpg";
const g2 = "/fashion-studio-showcase/assets/g2-BwEhyhbQ.jpg";
const g3 = "/fashion-studio-showcase/assets/g3-Bv8txtP6.jpg";
const g4 = "/fashion-studio-showcase/assets/g4-Bp3Z1XOF.jpg";
const g5 = "/fashion-studio-showcase/assets/g5-CtiNiKJT.jpg";
const g6 = "/fashion-studio-showcase/assets/g6-_1ArpxPx.jpg";
const g7 = "/fashion-studio-showcase/assets/g7-Jvm0q3MV.jpg";
const g8 = "/fashion-studio-showcase/assets/g8-D8w550vW.jpg";
const g9 = "/fashion-studio-showcase/assets/g9-zoB4Km9q.jpg";
const g10 = "/fashion-studio-showcase/assets/g10-qVzQk3lQ.jpg";
const images = [g1, g2, g3, g4, g5, g6, g7, g8, g9, g10];
function Marquee() {
  const loop = [...images, ...images];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden no-scrollbar w-full py-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-background to-transparent z-10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-background to-transparent z-10" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-5 marquee-track w-max", children: loop.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-0 group-hover:opacity-100 transition" })
        ]
      },
      i
    )) })
