...
const appCss = "/fashion-studio-showcase/assets/styles-fhA05zR6.css";
...
const Route$5 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Sri Dev Fashion Academy" },
      { name: "description", content: "Premier fashion design institute in Gandhipuram — Sri Dev Fashion Academy." },
      { name: "author", content: "Sri Dev Fashion Academy" },
      { property: "og:title", content: "Sri Dev Fashion Academy" },
      { property: "og:description", content: "Design Your Dream Career in Fashion." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400;1,600&family=Inter:wght@300;400;500;600&display=swap" }
    ]
  }),
...
const $$splitComponentImporter$4 = () => import("./pricing-BriTxgmY.js");
const Route$4 = createFileRoute("/pricing")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Transparent pricing for our Basic, Advanced, and Master fashion design programmes."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./courses-5lTI58lY.js");
const Route$3 = createFileRoute("/courses")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Eight signature programmes across Basic, Advanced and Master tiers — tailoring, blouse, churidar, designer wear, bridal couture and more."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./contact-4_Uf9W_Z.js");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Visit Sri Dev Fashion Academy at 2nd Street, Gandhipuram. Call 9344251898 to enroll."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-CYCUkYfY.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Discover the story, vision, and mission of Sri Dev Fashion Academy in Gandhipuram."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-C4wQw5Pm.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Premier fashion design institute in Gandhipuram. Master couture blouse design with expert mentorship at Sri Dev Fashion Academy."
    }, {
      property: "og:title",
      content: "Sri Dev Fashion Academy"
    }, {
      property: "og:description",
      content: "Design Your Dream Career in Fashion. Premier blouse design courses in Gandhipuram."
    }]
  }),
