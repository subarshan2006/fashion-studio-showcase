...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DhaAdKfv.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C-VyPS2E.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "fashion-studio-showcase";
var SERVER_FN_BASE = "/fashion-studio-showcase/_serverFn/";
